  ...
  routes: [
    { path: "/login", name: "login", component: () => import("../pages/LoginPage.vue"), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: "audit-logs/:id", name: "audit-log-detail", component: () => import("../pages/AuditLogDetailPage.vue") },
        ...
        { path: "broadcasts/new", name: "broadcast-create", component: () => import("../pages/BroadcastCreatePage.vue") },
        { path: "broadcasts/:id", name: "broadcast-detail", component: () => import("../pages/BroadcastDetailPage.vue") },
      ],
    },
